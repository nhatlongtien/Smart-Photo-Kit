...
class Frame_5ViewController: UIViewController {
...
extension Frame_5ViewController:ToolsFrameViewDelegate{
...
extension Frame_5ViewController:FMPhotoPickerViewControllerDelegate{
...
extension Frame_5ViewController:StickerViewControllerDelegate{
    func passStickerImage(sticker: UIImage?) {
        addStickerImageToFrameImage(image: sticker)
    }
}
//MARK: StickerViewDelegate
extension Frame_5ViewController:StickerViewDelegate{
