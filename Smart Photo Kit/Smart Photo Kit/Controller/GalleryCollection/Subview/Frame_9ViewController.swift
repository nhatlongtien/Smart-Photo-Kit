//
//  Frame_9ViewController.swift
//  Smart Photo Kit
//
//  Created by Tien Nguyen on 18/01/2022.
//

import UIKit
import StickerView
import FMPhotoPicker
class Frame_9ViewController: UIViewController {
...
extension Frame_9ViewController:ToolsFrameViewDelegate{
...
extension Frame_9ViewController:FMPhotoPickerViewControllerDelegate{
...
extension Frame_9ViewController:StickerViewControllerDelegate{
    func passStickerImage(sticker: UIImage?) {
        addStickerImageToFrameImage(image: sticker)
    }
}
//MARK: StickerViewDelegate
extension Frame_9ViewController:StickerViewDelegate{
