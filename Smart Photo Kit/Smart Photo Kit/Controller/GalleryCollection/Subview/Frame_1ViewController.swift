...
extension Frame_1ViewController:FMPhotoPickerViewControllerDelegate{
...
extension Frame_1ViewController:StickerViewControllerDelegate{
    func passStickerImage(sticker: UIImage?) {
        addStickerImageToFrameImage(image: sticker)
    }
}
//MARK:
extension Frame_1ViewController:StickerViewDelegate{
